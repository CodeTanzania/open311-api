define({ "api": [
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Unique Comment Id</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "request",
            "description": "<p>A service request which commented on</p>"
          },
          {
            "group": "Success 200",
            "type": "Object",
            "optional": false,
            "field": "commentator",
            "description": "<p>A party whose made a comment</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
            "optional": false,
            "field": "content",
            "description": "<p>A content of a comment</p>"
          },
          {
            "group": "Success 200",
            "type": "ObjectId",
          ...
          },
          {
            ...
            "optional": false,
            "field": "updatedAt",
            "description": "<p>Comment last updated date</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "count",
            "description": "<p>Number of Comments results  in the current json response</p>"
          }
        ]
      },
      "examples": [
    ...
    "filename": "app/routers/comment_router.js",
    "groupTitle": "Comment",
    "groupDescription": "<p>A record of a comment(or internal not) on a service request(issue) by a party.</p>",
    "sampleRequest": [
      {
        "url": "http://dawasco.herokuapp.com/comments/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example Usage",
        "content": "curl -i http://dawasco.herokuapp.com/permissions",
        "type": "json"
      }
    ],
    "success": {
    ...
    "sampleRequest": [
      {
        "url": "http://dawasco.herokuapp.com/comments"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "groupDescription": "<p>An entity (e.g municipal) responsible for addressing service request(issue).</p> <p>It may be a self managed entity or division within another entity(jurisdiction) in case there is hierarchy.</p>",
    "sampleRequest": [
      {
        ...
        "Success 200": [
          {
            ...
            "optional": true,
            "field": "jurisdiction",
            "description": "<p>Top jurisdiction under which this jurisdiction derived.s This is applicable where a large jurisdiction delegates its power to its division(s). If not set the jurisdiction will be treated as a top jurisdiction and will be affected by any logics implemented  accordingly.</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
  ...
  },
  {
    ...
    "groupTitle": "Priority",
    "groupDescription": "<p>Manage entity(i.e service &amp; service request(issue)) priority. Provides a way to prioritize service and service request types (issues) in order of their importance.</p>",
    "sampleRequest": [
      {
  ...
  },
  {
    ...
    "groupTitle": "Service",
    "groupDescription": "<p>An acceptable service (request types) e.g Water Leakage offered or handled by a specific jurisdiction.</p>",
    "sampleRequest": [
      {
  ...
  },
  {
    ...
    "groupDescription": "<p>Provide ability to group service offered by a jurisdiction(s) into meaningful categories e.g Sanitation It provides a way to group several service request types (issues) under meaningful categories such as Sanitation, Commercial, Billing, Non-Commercial etc.</p>",
    "sampleRequest": [
      {
  ...
  },
  {
    "type": "patch",
    "url": "/servicegroups/:id",
    "title": "Update(PATCH) Service Group",
    "group": "ServiceGroup",
  ...
  },
  {
    "type": "put",
    "url": "/servicegroups/:id",
    "title": "Update(PUT) Service Group",
    "group": "ServiceGroup",
  ...
  },
  {
    ...
    "groupDescription": "<p>An issue(or service request) reported by civilian(or customer) e.g Water Leakage occur at a particular area</p>",
    "sampleRequest": [
      {
  ...
  },
  {
    "type": "patch",
    "url": "/servicerequests/:id",
    "title": "Update(PATCH) Service Request",
    "group": "ServiceRequest",
  ...
  },
  {
    "type": "put",
    "url": "/servicerequests/:id",
    "title": "Update(PUT) Service Request",
    "group": "ServiceRequest",
  ...
  },
  {
        ...
        "Parameter": [
          {
            ...
            "optional": false,
            "field": "id",
            "description": "<p>Unique Setting Id</p>"
          }
        ]
      }
    },
        ...
        "Success 200": [
          {
            ...
            "optional": false,
            "field": "key",
            "description": "<p>Unique Setting Name</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
          ...
          },
          {
            ...
            "optional": false,
            "field": "createdAt",
            "description": "<p>Setting creation date</p>"
          },
          {
            "group": "Success 200",
            "type": "Timestamp",
            "optional": false,
            "field": "updatedAt",
            "description": "<p>Setting last updated date</p>"
          },
          {
            "group": "Success 200",
            "type": "String",
    ...
    "filename": "app/routers/setting_router.js",
    "groupTitle": "Setting",
    "groupDescription": "<p>Manage setting(s)</p>",
    "sampleRequest": [
      {
        "url": "http://dawasco.herokuapp.com/settings/:id"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "examples": [
      {
        "title": "Example Usage",
        "content": "curl -i http://dawasco.herokuapp.com/settings",
        "type": "json"
      }
    ],
    "success": {
      "fields": {
        "Success 200": [
          ...
          },
          {
            ...
            "optional": false,
            "field": "count",
            "description": "<p>Number of Setting results  in the current json response</p>"
          }
        ]
      },
      "examples": [
    ...
    "sampleRequest": [
      {
        "url": "http://dawasco.herokuapp.com/settings"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "groupTitle": "Status",
    "groupDescription": "<p>Manage entity(i.e service &amp; service request(issue)) status. Provides a way set status of service and service request types (issues) in order to track their progress.</p>",
    "sampleRequest": [
      {
